    ...
    public class TicTacToe
    {
        static void Main()
        {
            ...
            do
            {
                ...
                GameLoop(currentPlayer, gameBoard, ref xWins, ref yWins, ref ties, ref rounds);
        ...
        static void DrawScreen(char[,] dGameBoard, char dCurrentPlayer, int xWins, int yWins, int ties, int rounds, bool showPrompt)
        {
            Console.Clear();
        ...
        static void GameLoop(char currentPlayer, char[,] gameBoard, ref int xWins, ref int yWins, ref int ties, ref int rounds)
        {
            bool winner = false;
            char input;
            byte turns = 1;
