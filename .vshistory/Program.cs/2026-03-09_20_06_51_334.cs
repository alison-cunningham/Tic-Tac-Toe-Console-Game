...
namespace TicTacToe
{
    public class TicTacToe
    {
         ...
         * It recieves the 2D array gameBoard and fills it with numbers 1 through 9.
         */
        ...
        /*
         * The DrawScreen method fills a StringBuilder instance with everything that will be displayed on the screen.
         * 
         */
        ...
        /* the method GameLoop manages the flow of the game.
         * It calls the
         * 
         * 
         */
