    ...
    public class TicTacToe
    {
        static void Main()
        {
            ...
            do
            {
                ...
                GameLoop(ref currentPlayer, gameBoard, ref xWins, ref yWins, ref ties, ref rounds);
        ...
        static void GameLoop(ref char currentPlayer, char[,] gameBoard, ref int xWins, ref int yWins, ref int ties, ref int rounds)
        {
            bool winner = false;
            char input;
