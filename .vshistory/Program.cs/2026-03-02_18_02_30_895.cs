    ...
    public class TicTacToe
    {
        static void Main()
        {
            ...
            do
            {
                ...
                outcome = GameLoop(ref currentPlayer, gameBoard, ref xWins, ref yWins, ref ties, ref rounds);
        ...
        static char GameLoop(ref char currentPlayer, char[,] gameBoard, ref int xWins, ref int yWins, ref int ties, ref int rounds)
        {
            bool winner = false;
            char input;
